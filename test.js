//인공지능 20page까지 작업 : 190729
//artificial intelligence/머신러닝/스마트/빅데이터/machine learning/smart/Big data
const keywords = ["머신러닝", "인공지능"];
...
puppeteer.launch().then(async browser => {
    (async () => {
        ...
        // while(startPoint < lengthOfKeywords) {
            ...
            await page.goto('http://koreascience.or.kr/search.page?keywords=' + keywords[startPoint] + '&pageSize=10&pageNo=21');
            ...
            while (count <   9) {  //N번째 page까지 반복한다(2페이지 버튼의 index is 4)
                log("============" + i + "차 싸이클===========");
                i++;
                ...
                console.log("증가하기 전의 count 값 : " + count);
                count++;
